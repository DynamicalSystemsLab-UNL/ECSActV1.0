...
Ra = 1.0*np.array(input_file.get('/params/Ra'))+ 0.0025 #This is a continuaton step: increase Ra
time_limit = 4
...
T_guess = 1.0
c_guess = 1.7128600212766785 # Input initial guess for the wave speed here
